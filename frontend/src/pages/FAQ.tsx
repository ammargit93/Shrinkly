...
export function FAQ() {
  const schema = {
    ...
    'mainEntity': [
      ...
      },
      {
        ...
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'You can compress standard JPG/JPEG, PNG, and WebP images.',
        },
      },
      {
        '@type': 'Question',
        ...
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'When you select a file, Shrinkly draws it onto an offscreen canvas and exports it to a blob at variable quality settings. This happens entirely within your browser sandboxed environment, ensuring complete security.',
        },
      },
      {
        '@type': 'Question',
  ...
  useSeo({
    ...
    description: 'Find answers to common questions about Shrinkly image compression, supported formats, client-side security, and hosting options.',
    canonicalPath: '/faq',
    schema,
  });
    ...
    <div className="max-w-[700px] mx-auto px-4 py-8 sm:py-12 space-y-6 text-neutral-800 dark:text-neutral-350">
      ...
      <div className="space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-neutral-605 dark:text-neutral-400">
            You can compress standard JPG/JPEG, PNG, and WebP images.
          </p>
        </section>
